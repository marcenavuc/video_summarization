...
from video_summarization.src.metric import eval_metric_dummy


@hydra.main(config_path="../../confs", config_name="predict_small_sample")
def main(cfg):
    ...
    result_metric = eval_metric_dummy(preds, annotation)
    print(result_metric)
